...
namespace FDI.Base
{
    ...
    public partial class FDIEntities : DbContext
    {
        ...
        public DbSet<Advertising_Advertising_Zone_Mapping> Advertising_Advertising_Zone_Mapping { get; set; }
        public DbSet<Advertising_Category_Zone> Advertising_Category_Zone { get; set; }
        ...
        public DbSet<aspnet_UsersIPMembership> aspnet_UsersIPMembership { get; set; }
        public DbSet<aspnet_WebEvent_Events> aspnet_WebEvent_Events { get; set; }
        public DbSet<CayMoi> CayMois { get; set; }
        public DbSet<CheckAccount> CheckAccounts { get; set; }
        public DbSet<CheckAward> CheckAwards { get; set; }
        public DbSet<CheckLogin> CheckLogins { get; set; }
        public DbSet<Custome_RankCustomer> Custome_RankCustomer { get; set; }
        public DbSet<Custome_RankCustomerHistory> Custome_RankCustomerHistory { get; set; }
        public DbSet<Customer> Customers { get; set; }
        public DbSet<Customer_Type> Customer_Type { get; set; }
        public DbSet<Distributor> Distributors { get; set; }
        public DbSet<DynamicCustomer> DynamicCustomers { get; set; }
        public DbSet<Gallery_Picture> Gallery_Picture { get; set; }
        public DbSet<HistoryAwardLoop> HistoryAwardLoops { get; set; }
        public DbSet<HistoryAward> HistoryAwards { get; set; }
        public DbSet<HistoryAwaysMaRoi> HistoryAwaysMaRois { get; set; }
        public DbSet<HistoryUpRank> HistoryUpRanks { get; set; }
        public DbSet<HtmlSetting> HtmlSettings { get; set; }
        public DbSet<Language> Languages { get; set; }
        public DbSet<Log_Data> Log_Data { get; set; }
        public DbSet<LogSendSMSToCustomer> LogSendSMSToCustomers { get; set; }
        public DbSet<MenuGroup> MenuGroups { get; set; }
        public DbSet<Menu> Menus { get; set; }
        public DbSet<Module> Modules { get; set; }
        public DbSet<ModuleControl> ModuleControls { get; set; }
        public DbSet<Module1> Modules1 { get; set; }
        ...
        public DbSet<ProvincialAgency> ProvincialAgencies { get; set; }
        public DbSet<Rank> Ranks { get; set; }
        public DbSet<RankCustome> RankCustomes { get; set; }
        public DbSet<RankNow> RankNows { get; set; }
        public DbSet<RankNow_BackUp> RankNow_BackUp { get; set; }
        public DbSet<RegisteredAgency> RegisteredAgencies { get; set; }
        public DbSet<Role_ModuleActive> Role_ModuleActive { get; set; }
        public DbSet<Shop_Log_System> Shop_Log_System { get; set; }
        public DbSet<Shop_Order_Product> Shop_Order_Product { get; set; }
        ...
        public virtual int AddAwardsLoop()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AddAwardsLoop");
        }
        ...
        public virtual int BackupRankNow()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("BackupRankNow");
        }
    
        public virtual int DeleteAwardsByRankID(Nullable<int> rankID)
        {
            var rankIDParameter = rankID.HasValue ?
                new ObjectParameter("RankID", rankID) :
                new ObjectParameter("RankID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("DeleteAwardsByRankID", rankIDParameter);
        }
    
        public virtual int ExcelTotalAwardByNPP(Nullable<int> year, Nullable<int> month, Nullable<int> pageIndex, Nullable<int> pageSize, string codeHH, string userName, string code)
        {
            ...
            var codeHHParameter = codeHH != null ?
                new ObjectParameter("CodeHH", codeHH) :
                new ObjectParameter("CodeHH", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ExcelTotalAwardByNPP", yearParameter, monthParameter, pageIndexParameter, pageSizeParameter, codeHHParameter, userNameParameter, codeParameter);
        }
        ...
        public virtual ObjectResult<HistoryRankCustomer_Result> HistoryRankCustomer(string customerid, string userName, Nullable<int> year, Nullable<int> month)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<HistoryRankCustomer_Result>("HistoryRankCustomer", customeridParameter, userNameParameter, yearParameter, monthParameter);
        }
    
        public virtual int InsertHHGroup(Nullable<decimal> price, Nullable<int> id)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertHHGroup", priceParameter, idParameter);
        }
    
        public virtual int ListTeenLevel(Nullable<int> id, Nullable<int> level)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ListTeenLevel", idParameter, levelParameter);
        }
    
        public virtual ObjectResult<Menu_GetChildByParentId_Result> Menu_GetChildByParentId(Nullable<int> groupId, Nullable<int> parent, string languageId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Menu_GetChildByParentId_Result>("Menu_GetChildByParentId", groupIdParameter, parentParameter, languageIdParameter);
        }
        ...
        public virtual ObjectResult<sp_ExeclStatisticCommissionByMonth_Result> sp_ExeclStatisticCommissionByMonth(Nullable<int> year, Nullable<int> month, string userName, string code)
        {
            var yearParameter = year.HasValue ?
                new ObjectParameter("year", year) :
                new ObjectParameter("year", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_ExeclStatisticCommissionByMonth_Result>("sp_ExeclStatisticCommissionByMonth", yearParameter, monthParameter, userNameParameter, codeParameter);
        }
        ...
        public virtual int TotalPVParentId(string myString, Nullable<decimal> pricePv)
        {
            var myStringParameter = myString != null ?
                new ObjectParameter("MyString", myString) :
                new ObjectParameter("MyString", typeof(string));
    
            var pricePvParameter = pricePv.HasValue ?
                new ObjectParameter("PricePv", pricePv) :
                new ObjectParameter("PricePv", typeof(decimal));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("TotalPVParentId", myStringParameter, pricePvParameter);
        }
    
        public virtual int UpdateCayHeThong(string myString)
        {
            var myStringParameter = myString != null ?
                new ObjectParameter("MyString", myString) :
                new ObjectParameter("MyString", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateCayHeThong", myStringParameter);
        }
    
        public virtual int UpdateTotalCaymoi()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateTotalCaymoi");
        }
    
        public virtual int UpRankNPP()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpRankNPP");
        }
    }
}
